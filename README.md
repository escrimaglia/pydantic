...
Data templates generated by data_template_generation.py module that will feed the automation proccess. I personally use a yaml template because it is more user friendly than json.
